...
namespace Boss_Game_2._0.Screens
{
    class Message : Screen
    {
        ...
        public Message(SpriteBatch spriteBatch) : base(spriteBatch)
        {
            ...
            messages.Add("I've been living in the village of Arathia for 15 years now.");
            ...
            messages.Add("This is a test, youll need to do an add message to add new\n transistion(s). Youll need to manually add brackets or \nbackslash n to space out the letters");
        ...
        {
            spriteBatch.Draw(TextureManager.Message.Bg, new Rectangle(0, 0, 800, 800), Color.White);
