...
namespace Boss_Game_2._0.Screens.Bosses
{
    class Boss3Screen : BossScreen
    {
        ...
        public Boss3Screen(SpriteBatch spriteBatch) : base(spriteBatch)
        {
        ...
        private void switchAttack()
        {
            ...
            {
                case 0:
                    bossAttack = new TopBottom(spriteBatch, 0, -0, (float)Math.PI / 15, (float)Math.PI / 2, 200, 0, 0, 15, 10, 60);
                    break;
                case 1:
                    bossAttack = new Spiral(spriteBatch, 400, 250, (float)Math.PI / 31, (float)Math.PI / 2.2f, 250, 0, 0, 15, 10, 8);
                    break;
                case 2:
                    bossAttack = new MovingCircles(spriteBatch, 0, 0, (float)Math.PI / 12, (float)Math.PI / 2, 250, 0, 0, 15, 8, true);
                    break;
                case 3:
                    bossAttack = new RandomCircles(spriteBatch, 0, 0, (float)Math.PI / 12, (float)Math.PI / 12, 300, 0, 0, 15, 10, 240);
                    break;
        ...
        {
            spriteBatch.Draw(TextureManager.Textures.Placeholder3, Window, Color.White * 0.2f);

            spriteBatch.Draw(TextureManager.Bosses.Boss3.MagmaBoss, new Rectangle(bossX - 126, bossY, 384, 384), new Rectangle(0, sourceRectY, 384, 384), Color.White); // TODO: make a boss class that will have its own .Draw() method with this code
