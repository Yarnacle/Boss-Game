...
namespace Boss_Game_2._0.Screens.Bosses.Attacks
{
    class RandomCircles : BossAttack
    {
        ...
        public RandomCircles(SpriteBatch spriteBatch, int centerX, int centerY, float angSpacing, float angSpeed, int projectileSpeed, float xAccel, float yAccel, int projectileSize, int attackTime, int spawnIntervalMs) : base(spriteBatch, projectileSpeed)
        {
